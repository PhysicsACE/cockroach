...
var elementSchemaOptions = []rel.SchemaOption{
	...
	rel.EntityMapping(t((*scpb.DomainConstraint)(nil)),
		rel.EntityAttr(DescID, "DomainTypeID"),
		rel.EntityAttr(Expr, "CheckConstraint"),
	),
	...
	rel.EntityMapping(t((*scpb.DomainDefaultExpression)(nil)),
		rel.EntityAttr(DescID, "DomainTypeID"),
		rel.EntityAttr(Expr, "DefaultExpr"),
	),

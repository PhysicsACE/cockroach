...
func makePGGetViewDef(paramTypes tree.ParamTypesWithModes) tree.Overload {
...
func makePGGetConstraintDef(paramTypes tree.ParamTypesWithModes) tree.Overload {
	return tree.Overload{
		Types:      paramTypes,
		ReturnType: tree.FixedReturnType(types.String),
...
var pgBuiltins = map[string]builtinDefinition{
	...
	"pg_get_constraintdef": makeBuiltin(tree.FunctionProperties{DistsqlBlocklist: true},
		makePGGetConstraintDef(tree.ParamTypesWithModes{
			{Name: "constraint_oid", Typ: types.Oid}, {Name: "pretty_bool", Typ: types.Bool}}),
		makePGGetConstraintDef(tree.ParamTypesWithModes{{Name: "constraint_oid", Typ: types.Oid}}),
	),
	...
	"pg_get_viewdef": makeBuiltin(
		tree.FunctionProperties{Category: builtinconstants.CategorySystemInfo, DistsqlBlocklist: true},
		makePGGetViewDef(tree.ParamTypesWithModes{{Name: "view_oid", Typ: types.Oid}}),
		makePGGetViewDef(tree.ParamTypesWithModes{{Name: "view_oid", Typ: types.Oid}, {Name: "pretty_bool", Typ: types.Bool}}),
	),

...
type TypeList interface {
	...
	String() string
	// AcceptsVariadic returns if it is a variadic function
	...
	// Given a list of arguments, generate a function signature with respect to this specific overload typelis

...
// func (c*CustomFuncs) IsConstSubscripts(input opt.ScalarListExpr) bool {
...
// func (c *CustomFuncs) FoldIndirection(input, index opt.ScalarListExpr) (_ opt.ScalarExpr, ok bool) {
